...
public class P04Handler extends SQLiteOpenHelper {
    // create a table called P04
    public static final String TABLE_P04 = "P04";
    ...
    public P04Handler(@Nullable Context context) {
        super(context, "P04.db", null, 4);
    }

    @Override
    public void onCreate(SQLiteDatabase db) {
        // sql command to create the table with ID and Name and StudentID
        String CREATE = "CREATE TABLE P04 " + "(ID INTEGER PRIMARY KEY AUTOINCREMENT, " +
    ...
    public void onUpgrade(SQLiteDatabase db, int oldVersion, int newVersion) {
        db.execSQL("DROP TABLE IF EXISTS " + TABLE_P04);
        onCreate(db);
    }
    ...
    public void addNewStudent(students student) {
        ...
        // insert into P04 table
        db.insert(TABLE_P04, null,values);
    ...
    public ArrayList<students> getStudents()
    {
        ...
        String query = "SELECT * FROM " + TABLE_P04;
        // get writable database
        SQLiteDatabase db = this.getWritableDatabase();
